def get_topwords_for_image_search(data: list, top_num: int =10):
    '''
    Args: 
        data: a list of raw json format image data 
...
def get_topwords_for_speech_search(data: list, top_num: int =10):
    '''
    Args: 
...
def get_topwords_for_text_search(data: list, top_num: int =10):
    pass


def get_topwords_list(topwords_lookup: dict, top_num: int):
